	...
	extern  LCD_Setup, LCD_Write_Message, LCD_Write_Hex, LCD_Clear	; external LCD subroutines
	extern	LCD_Cursor_Go_Home,LCD_Cursor_D,LCD_Cursor_R,LCD_Send_Byte_D , LCD_Cursor_L ; external LCD subroutines
