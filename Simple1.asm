	...
	extern  setup_keypad, keypad_start, khigh, klow, test, play_song, c_test
	global	myTable
...
setup	call	setup_keypad	    ; sets up keypad
	...
	movwf	khigh
	movlw	0x64
	movwf	klow		    ; set the sample rate to 20KHz
...
start	clrf	LATC		    ; clears port c outputs	
	...
	movwf	T1CON		    ; = 2MHz clock rate, approx 1sec rollover
...
int_hi	code 0x0018		    ; high vector, no low vector
